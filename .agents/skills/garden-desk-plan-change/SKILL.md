...
1. Read the Top Priority rule, current phase, and Test Rule in [AGENTS.md](../../../AGENTS.md), and the active gate in [the implementation plan](../../../docs/IMPLEMENTATION_PLAN.md).
