...
export const XLSX_EXECUTION_INSTRUCTIONS = [
  ...
  "At the end of every successful XLSX execution print exactly VAULT_XLSX_FILES_DONE=<integer>, VAULT_XLSX_FILES_TOTAL=<integer>, and VAULT_XLSX_COMPLETE=<0-or-1>. Set COMPLETE=1 only when DONE equals TOTAL and the complete corpus was read.",
