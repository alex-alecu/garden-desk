...
pub fn configuration(arguments: &Arguments) -> Result<String, Box<dyn Error>> {
    ...
    let template = r#"{"Owner":"Garden Desk M1","SchemaVersion":{"Major":2,"Minor":1},"ShouldTerminateOnLastHandleClosed":true,"VirtualMachine":{"StopOnReset":true,"Chipset":{"LinuxKernelDirect":{"KernelCmdLine":"console=ttyS0 init=/sbin/init panic=-1 dummy.numdummies=0 initcall_blacklist=virtio_vsock_init pci=off","KernelFilePath":"$KERNEL","InitRdPath":"$INITRAMFS"}},"ComputeTopology":{"Memory":{"AllowOvercommit":true,"SizeInMB":$MEMORY},"Processor":{"Count":$CPUS}},"Devices":{"Scsi":{"garden-desk-scsi":{"Attachments":{$SCSI}}},"HvSocket":{"HvSocketConfig":{"DefaultBindSecurityDescriptor":"D:P(A;;FA;;;SY)(A;;FA;;;BA)","ServiceTable":{"00000fd2-facb-11e6-bd58-64006a7986d3":{"AllowWildcardBinds":true,"BindSecurityDescriptor":"D:P(A;;FA;;;WD)","ConnectSecurityDescriptor":"D:P(A;;FA;;;SY)(A;;FA;;;BA)(A;;FA;;;S-1-5-32-578)"}}}}$PLAN9}}}"#;
    Ok(template
