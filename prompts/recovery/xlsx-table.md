The previous Python table formatter split a source line around Markdown pipe characters, emitted an invalid escape-sequence warning, or called `reset_dimensions()` on a normal OpenPyXL `Worksheet`.
