...
Table: field, both sources/values, conflict, reason, and check. Cite both locations; absence cites expected place/checked parts. Never invent correction; separate fact, interpretation, missing information, and human decision; rank only with known party/goal. Do not edit unless requested. Do not say valid, enforceable, compliant, or safe. Qualified human review is required for legal decisions.
