...
Use `Possible duplicate` unless separate evidence proves one transaction. Mark a missing approval or receipt `not documented`; do not treat it as proof that approval or support did not exist. Output one table: category; record identifier; source fact; evidence location; supplied criterion; required check. Do not approve payment, reject an expense, or give tax, fraud, compliance, or posting conclusions. Require qualified finance or accounting review.
