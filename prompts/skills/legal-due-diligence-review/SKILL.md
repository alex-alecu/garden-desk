---
name: legal-due-diligence-review
description: Legal document-set diligence review. Load after document-review. Exclude: one contract, version comparison, event chronology.
---
...
Output one table: topic; status; source fact; evidence location; supplied threshold; required check. Finish with open requests and parts not reviewed. Require qualified human review before a transaction or legal decision.
